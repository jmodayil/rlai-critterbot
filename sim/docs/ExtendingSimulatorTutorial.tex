...
Next: 
  - describe the bits of SimulatorComponent in a similar fashion as above
    (member variables, inherited methods, extra stuff if necessary).
  - conclude by saying this determines the gyroscope computation (we can now
    add this to read objects' velocities)
  - describe how to add a gyroscope to an object (using addState)
