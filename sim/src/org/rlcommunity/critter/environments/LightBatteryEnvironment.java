...
//        id = CommonObjects.addObject(objects,
//                CommonObjects.generateLightSource("LightSource1", id,100),
//                new Vector2D(0.5, 0.5), 0.0, id); //something funnie going on with positions
//
//        id = CommonObjects.addObject(objects,
//                CommonObjects.generateLightSource("LightSource2", id,100),
//                new Vector2D(0.5, 2.5), 0.0, id); //something funnie going on with positions        
//
//        id = CommonObjects.addObject(objects,
//                CommonObjects.generateLightSource("LightSource3", id,75),
//                new Vector2D(2.5, 2.5), 0.0, id); //something funnie going on with positions   
        
        id = CommonObjects.addObject(objects,
                CommonObjects.generateLightSource("LightSource4", id,400),
                new Vector2D(0.25, 4.25), 0.0, id); //something funnie going on with positions   
//        
//        id = CommonObjects.addObject(objects,
//                CommonObjects.generateLightSource("LightSource5", id, 100),
//                new Vector2D(0.2, 0.2), 0.0, id); //something funnie going on with positions           
