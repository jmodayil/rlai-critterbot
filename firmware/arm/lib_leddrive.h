...
enum leddrive_states {STARTUP,BOOT,MI,UI,CHARGESTATUS,BATSTATUS,ANGLE,ROTATE,GRADIENT,CLEAR,STOP,BALL,FADEANGLE,ERROR,EMERG,BUSY,COLORDIS,BYTE,RAINBOW,CUSTOM};
